...
export const ProductListing: React.FC = () => {
    ...
    const saveHandler = useCallback(() => {
        console.log('save handler for updating product')
    }, [])
        ...
        <tr>
            ...
            <td className="px-4 border-r border-b border-slate-200 py-2 whitespace-nowrap w-10">
                <div className="flex items-center">
                    ...
                    <button onClick={() => setEditModal(true)} className="ml-1.5 bg-yellow-600 hover:bg-yellow-700 px-1.5 py-1.5 rounded-lg text-gray-100">
