    ...
    return (
        <tr>
            ...
            <td className="px-4 border-r border-b border-slate-200 py-2">
                <span className="cursor-pointer text-gray-400 hover:text-gray-500" onClick={() => setDetailModal(true)}>
                    16678923762730
                </span>
            </td>
            <td className="px-4 border-r border-b border-slate-200 py-2 whitespace-nowrap">Paket Lite Cocok</td>
            ...
            <td className="px-4 border-r border-b border-slate-200 py-2 whitespace-nowrap">Sep 20, 2022 15:10:20</td>
            <td className="px-4 border-r border-b border-slate-200 py-2 whitespace-nowrap w-10">
                <div className="flex items-center">
                    <button onClick={handleClickDelete} className="bg-red-700 hover:bg-red-800 px-1.5 py-1.5 rounded-lg">
                    ...
                    <div className="inline-flex ml-1.5 border-l border-gray-300 h-6"></div>
                    <button onClick={() => setDetailModal(true)} className="ml-1.5 bg-yellow-600 hover:bg-yellow-700 px-1.5 py-1.5 rounded-lg">
