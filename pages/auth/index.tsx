        ...
        <div className="flex justify-center" ref={wrapRef}>
            <div className="mt-20 max-w-xs w-80">
                ...
                <div className="mt-7">
                    ...
                    >
                        <input className="w-full outline-none rounded-md text-gray-500 text-base font-medium roboto" type={showPass ? 'text' : 'password'} placeholder="Password" />
                        {isPassOn ? (
                            <span className="text-gray-300 cursor-pointer absolute right-2.5">
